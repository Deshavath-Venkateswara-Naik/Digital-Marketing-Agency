...
const AboutUsPage = () => {
  return (
    <Container className="about-container">
      <Row>
        <Col>
          <h2>About Digital Pulse Marketing</h2>
          <p>
      ...
      <Row>
        <Col>
          <h2>Your Premier Digital Marketing Partners</h2>
          <p>
      ...
      <Row>
        <Col>
          <h2>Our History</h2>
          <p>
            Digital Pulse Marketing was founded by Deshavath Venkateswara Naik. Deshavath Venkateswara Naik's journey into entrepreneurship was ignited by a deep-seated passion for business and technology. Recognizing the transformative power of technology, he sought to harness its potential to drive positive change and innovation.
          </p>
          <p>
            The Digital Marketing Pulse was started in 2025 as a startup with a small team with high passion and skills solving problems and increasing customer satisfaction as their key goal. In the future, we are planning to expand our service to other countries.
          </p>
        </Col>
      </Row>
      ...
      <Row className="cta-section">
        <Col>
          <h2>Looking to Increase Your Business?</h2>
          <p>
